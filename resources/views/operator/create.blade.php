...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-header"><h3>Create a new Vessel Operator</h3></div>
            <div class="card-body">
                @include('inc.errors')
                ...
                <form method="POST" action="{{ route('operator.store') }}">
                    ...
                    <div class="box-rounded-lime mb-4 shadow">
                        <h5 class="box-title">This information is the minimum necessary to create a new Operator</h5>
                        <div class="form-group">
                            <label for="name">Name of the Vessel Operator</label>
                    ...
                    <div class="box-rounded-grey mb-4 shadow">
                        <h5 class="box-title">The Operator's physical address, also useful for people who use GPS</h5>
                        <div class="form-group">
                    ...
                    <div class="box-rounded-white mb-4 shadow">
                        <h5 class="box-title">If the Operator has a website or is on social media, please add it here</h5>
                        <div class="form-group">
                            <label for="url">Website of the Operator</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <label for="facebook">FaceBook page of the Operator</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <label for="twitter">Twitter account of the Operator</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <label for="instagram">Instagram account of the Operator</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                    ...
                    <div class="box-rounded-white mb-4 shadow">
                        ...
                        <div class="form-group">
                            <label for="lat">The Operator's latitude</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <label for="lng">The Operator's longitude</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><span class="fas fa-map-marker-alt"></span></div>
                                </div>
