...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-header"><h3>Edit the Operator <strong>{{ $operator->name }} ({{ $operator->city->name }})</strong></h3></div>
            <div class="card-body">
                @include('inc.errors')

                <form method="POST" action="{{ route('operator.update') }}">
                    <input name="_method" type="hidden" value="PUT">
                    <input name="id" type="hidden" value="{{ $operator->id }}">
                    @csrf
                    <div class="box-rounded-lime mb-4 shadow">
                        <h5 class="box-title">This information is the minimum necessary for any Operator</h5>
                        <div class="form-group">
                            <label for="name">Name of the Operator</label>
                            <div class="input-group">
                                ...
                                @elseif (count($errors) > 0)
                                    <div class="valid-feedback ml-5">Valid Operator name</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="company_name">Company Name of the Vessel Operator</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><span class="fas fa-building"></span></div>
                                </div>
                                <input type="text"
                                       class="form-control @if ($errors->has('company_name')) is-invalid @elseif (count($errors) > 0) is-valid @endif"
                                       name="company_name" id="company_name" aria-describedby="companyNameHelp" placeholder="" max="255"
                                       value="{{ $operator->company_name }}">
                                @if ($errors->has('company_name'))
                                    <div class="invalid-feedback ml-5 bigger-110">{{ $errors->first('company_name') }}</div>
                                @elseif (count($errors) > 0)
                                    <div class="valid-feedback ml-5">Valid Company name</div>
                                @endif
                            </div>
                            <small id="companyNameHelp" class="form-text grey">
                                The Company Name can be the same as the Operator name. Sometimes it can be the mother company operating nationwide.
                            </small>
                        </div>
                        <div class="form-group">
                            ...
                            <small id="emailHelp" class="form-text grey">
                                This email is for internal use only. This address will receive the auto generated reports for this Operator.
                            </small>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                       ...
                                       name="city_id" id="city_id" aria-describedby="cityHelp" placeholder="(start typing)" max="255"
                                       value="{{ $operator->city_id }}">
                            ...
                            <small id="cityHelp" class="form-text grey">
                                Please start typing and choose a city from the dropdown list.
                            </small>
                        </div>
                    </div>

                    <div class="box-rounded-grey mb-4 shadow">
                        <h5 class="box-title">The Operators's physical address, also useful for people who use GPS</h5>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="address1" id="address1" aria-describedby="addressHelp"
                                       placeholder="" max="255" value="{{ $operator->address1 }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="contact_nr" id="contact_nr" aria-describedby="contactHelp"
                                       placeholder="" max="255" value="{{ $operator->contact_nr }}">
                            </div>
                    ...
                    <div class="box-rounded-lime mb-4 shadow">
                        ...
                        <div class="form-group">
                            <label for="emergency_nr">Emergency number</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control" name="emergency_nr" id="emergency_nr" aria-describedby="emergencyHelp"
                                       placeholder="" max="255" value="{{ $operator->emergency_nr }}">
                            </div>
                    ...
                    <div class="box-rounded-grey mb-4 shadow">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" name="body" id="body" placeholder="">{{ $operator->body }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" name="official_info" id="official_info"
                                          placeholder="">{!! $operator->official_info !!}
                                </textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary">Update {{ $operator->name }}</button>
                </form>
            </div>
        </div>
    </div>
